...
const RoomPage = ({ onCreateRoom }) => {
  ...
  const handleToggleFavorite = (id) => {
    const isSelected = selectedRestaurants.some((r) => r.id === id);

    if (isSelected) {
      // Remove the restaurant from the list of selected restaurants
      setSelectedRestaurants((prevSelected) =>
        prevSelected.filter((r) => r.id !== id)
      );
    } else {
      // Add the restaurant to the list of selected restaurants
